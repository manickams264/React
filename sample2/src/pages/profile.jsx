    ...
    <>
      <div className="w-screen flex ">
        <div className='w-[70%] h-80 flex justify-center items-center bg-stone-400 py-5'>
          <div className="w-full h-[50%] flex text-4xl text-white font-extrabold justify-center items-center bg-purple-500 p-3">
            Hi i am Manickam S
          </div>
        </div>
      ...
      <div className="w-screen flex">
        <div className="h-40 w-[90%] flex text-2xl font-bold text-white justify-center items-center p-2 bg-purple-500">
